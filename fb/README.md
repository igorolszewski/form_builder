...
### Visual Studio Code +  for Chrome
> Install [ for Chrome](https://marketplace.visualstudio.com/items?itemName=msjsdiag.-for-chrome) and see docs for instructions to launch Chrome
